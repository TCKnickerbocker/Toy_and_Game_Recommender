...
def call_model_2(user_id, num_recently_rated, num_recs_to_give, by_title=False): 
    ...
    try:
        ...
        with get_db_connection() as conn:
            ...
            recently_rated_products = model_2_helper_functions.get_recently_rated_products_info(
            ...
            end_time2 = time.time()
            print(f"get_n_most_similar_product_ids_model_2 for {num_recently_rated} products took: {end_time2 - end_time1:.2f} seconds")
            ...
            x = model_2_helper_functions.get_products_by_product_ids(conn, product_ids_to_rec)
            end_time4 = time.time()
...
@app.route("/recommend_products_sentiment_model", methods=["GET"])
