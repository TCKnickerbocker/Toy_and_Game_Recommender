    ...
    try:
        ...
        with get_db_connection() as conn:
            ...
            recently_rated_products = (
                model_3_helper_functions.get_recently_rated_products_info(
            ...
            end_time2 = time.time()
            print(
                f"get_n_most_similar_product_ids_model_3 for {num_recently_rated} products took: {end_time2 - end_time1:.2f} seconds"
            )
            ...
            x = model_3_helper_functions.get_products_by_product_ids(
...
@app.route("/call_model_3", methods=["GET"])
