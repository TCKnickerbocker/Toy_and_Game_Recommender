...
import model_4_helper_functions
import model_4_alg
from model_4_configs import CONNECTION_PARAMS
import logging
import time
...
def call_model_4(user_id, num_recently_rated, num_recs_to_give, by_title=False):
    """
    ...
    try:
        ...
        with get_db_connection() as conn:
            ...
            recently_rated_products = (
                model_4_helper_functions.get_recently_rated_products_info(
            ...
            with concurrent.futures.ThreadPoolExecutor(
                ...
                for rating_info in recently_rated_products:
                    ...
                    future = executor.submit(
                        model_4_helper_functions.get_n_most_similar_product_ids_model_4,
                        conn,
                        product_id,
                        n=num_recs_to_give,
                        # by_title,
            ...
            end_time2 = time.time()
            print(
                f"get_n_most_similar_product_ids_model_4 for {num_recently_rated} products took: {end_time2 - end_time1:.2f} seconds"
            )
            # Get products to recommend
            product_ids_to_rec = model_4_alg.recommend_products(
            ...
            x = model_4_helper_functions.get_products_by_product_ids(
...
@app.route("/call_model_4", methods=["GET"])
